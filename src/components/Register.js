            ...
            <Container>
                ...
                <Content contentContainerStyle={styles.bgFullWidth}>
                        <View
                                ...
                                <Form
                                    ...
                                    <View
                                        ...
                                        <View
                                            ...
                                            <Icon style={[styles.text_light_red, styles.textSize_22]} type="AntDesign"
                                                  name='user'/>
                                        </View>
                                    </View>
                                    ...
                                    <View
                                        ...
                                        <View
                                            ...
                                            <Icon style={[styles.text_light_red, styles.textSize_22]}
                                    ...
                                    <View style={[styles.rowRight, styles.marginVertical_20]}>
                                        <TouchableOpacity style={[styles.rowRight, styles.marginVertical_10]}>
                                            <CheckBox
                                                style={[styles.checkBox, styles.Border, styles.bg_light_red]}
                            ...
                            <View
                                style={[styles.bg_semon, styles.SelfLeft, styles.paddingHorizontal_10, styles.height_100, styles.centerContext, styles.marginVertical_25]}>
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('Login')}
                                                  style={[styles.bg_light_red, styles.paddingHorizontal_10, styles.height_40, styles.centerContext]}>
                                    <Text style={[styles.textRegular, styles.textSize_14, styles.text_White]}>
                                        {i18n.t('login')}
                                    </Text>
                                </TouchableOpacity>
